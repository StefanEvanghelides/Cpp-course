...
int main(int argc, char *argv[])
{
	...
	size_t value = stoul(input, nullptr, BINARY); //Convert binary string 
																								//to integral value;
	...
	if (!direction.compare("ror"))
		...
		//correct location. Note that left shifting introduces bits outside 
		//the bit-range which are removed
